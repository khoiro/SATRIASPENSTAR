  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column"
        ...
        <!-- MASTER DATA -->
        <li class="nav-item has-treeview <?= in_array(($page ?? ''), ['manage','siswa','kamar','bus','buskelas']) ? 'menu-open' : '' ?>">
          <a href="#"
             class="nav-link <?= in_array(($page ?? ''), ['manage','siswa','kamar','bus','buskelas']) ? 'active' : '' ?>">
